      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
          ...
          <div className="space-y-4 md:space-y-6">
            <div>
              <Badge variant="default" className="mb-2 md:mb-3 text-xs md:text-sm">
              ...
              <div className="flex items-baseline gap-2 md:gap-3 mb-4 md:mb-6">
                ...
                <span className="text-base md:text-xl text-gray-600">/{product.unit}</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              {product.inStock ? (
                <Badge variant="success" className="text-xs md:text-sm py-1.5 md:py-2 px-3 md:px-4">
                  ✓ En stock
                </Badge>
              ) : (
                <Badge variant="error" className="text-xs md:text-sm py-1.5 md:py-2 px-3 md:px-4">
                  Rupture de stock
                </Badge>
              )}
            </div>
